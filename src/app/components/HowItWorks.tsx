...
const HowItWorks = () => {
    return (
        <div className='flex justify-center items-center flex-col text-center mt-[100px]'>
            ...
            <div className='lg:px-[202px] flex lg:flex-row flex-col gap-[202px]'>
                <div className='flex flex-col items-center text-center'>
                    <Image src={h1} alt="" />
                    <h3 className='text-[32px] font-semibold mt-[26px]'>Create An Account & Add Balance</h3>
                ...
                <div className='flex flex-col items-center text-center'>
                    <Image src={h2} alt="" />
                    <h3 className='text-[32px] font-semibold mt-[26px]'>Select Your <br /> Targeted Service</h3>
                ...
                <div className='flex flex-col items-center text-center'>
                    <Image src={h3} alt="" />
                    <h3 className='text-[32px] font-semibold mt-[26px]'>Provide Link, Quantity & Watch Results!</h3>
